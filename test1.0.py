    ...
    try:
        with engine.connect() as connection:
            ...
            if result:
                ...
                connection.execute(text(update_query), {'new_total': new_total, 'user': user})
                ...
                print(f"Novo registro inserido para {user}: {pages} páginas, Limite de impressão: {DEFAULT_PRINT_LIMIT} páginas.")
